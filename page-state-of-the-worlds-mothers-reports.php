<?php
/**
/* Template Name: State of the Worlds Mother's Reports */
...
$args = array(
    ...
    'meta_key'		=> 'type',
    'meta_value'	=> "State of the World's Mothers Report",
    'posts_per_page' => -1
);            // query
...
<?php while( $the_query->have_posts() ) : $the_query->the_post(); ?>
    ...
    <div class="overflow publications-item-container">
        ...
        <div class="publications-title col-lg-9 col-md-9 col-sm-9"><span><a href="<?php echo the_field('publication_doc'); ?>" target="_blank"><?php the_field( "title" );?> </a></span><span class="date"><?php the_field( 'date' )?></span>
